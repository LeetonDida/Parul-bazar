        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Painel of Users:</h6>
                    <a class="collapse-item text-primary" href="users"><i class="fa fa-fw fa-list"></i> Sellers</a>
                    <a class="collapse-item text-info" href="#"><i class="fa fa-fw fa-edit"></i> Admins</a>
                </div>
            </div>
        </li>
