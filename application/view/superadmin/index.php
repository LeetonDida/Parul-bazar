<?php include_once ('../layouts/super_admin_header.php') ?>
    ...
    <!-- Content -->
<?php
$sql = "SELECT (SELECT count(*) FROM products) as total_products,
  		 (select count(*) from users) as total_sellers";
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $row['total_sellers']?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $row['total_products']?></div>
                            </div>
                            <div class="col-auto">
